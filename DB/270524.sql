...
-- Dumping data for table testifly.category: ~16 rows (approximately)
...
-- Dumping data for table testifly.otpstore: ~3 rows (approximately)
...
-- Dumping data for table testifly.result: ~3 rows (approximately)
...
INSERT INTO `selfguru` (`sgid`, `questionname`, `option1`, `option2`, `option3`, `option4`, `correctans`, `status`, `catagory`) VALUES
	(1, 'What is this capital of India?', 'Chennai', 'Delhi', 'Kolkata', 'Mumbai', 2, 1, 1),
	(2, 'What is this capital of Tamilnadu?', 'Chennai', 'Salem', 'Namakkal', 'Covai', 1, 1, 1),
	(3, '\r\nWhich is the capital of Goa?', 'Assom', 'Kolkata', 'New Delhi', 'Panaji', 4, 1, 1),
	(4, 'What is the capital of Kerala?', 'Salem', 'Tiruvanantapuram', 'New Delhi', 'Nainital', 2, 1, 1),
	(5, 'National Flower of India', 'Lilly', 'Lotus', 'Maligai', 'cherry', 2, 1, 1),
	(6, 'Guess the capital city of Maharashtra', 'Chennai', 'Kolkata', 'New Delhi', 'Mumbai', 4, 1, 1),
	(7, 'This is the capital city of the picturesque state of Uttarakhand', 'Dehradun', 'Shimla', 'Nainital', 'Ooty', 1, 1, 1),
	(8, 'The capital city of this northeastern state is Dispur', 'Meghalaya', 'Assom', 'Tripura', 'Mizoram', 2, 1, 1),
	(9, 'This union territory has Kavaratti as its capital', 'Chandigarh', 'Daman & Diu', 'Dadra & Nagar Haveli', 'Lakshadweep', 4, 1, 1),
	(10, 'Guess are the capital of Andaman & Nicobar Islands', 'Pondicherry', 'Port Blair', 'Daman', 'None of the above', 2, 1, 1),
	(11, 'Which of the following cities is the capital of Arunachal Pradesh?', 'Raipur', 'Panaji', 'Itanagar', 'Bhopal', 3, 1, 1),
	(12, 'Odisha’s capital is?', 'Bhubaneshwar', 'Puri', 'Cuttack', 'Calcutta', 1, 1, 1),
	(13, 'Which of these is the capital of the state of Uttar Pradesh?', 'Lucknow', 'Prayagraj', 'Kanpur', 'Indore', 1, 1, 1),
	(14, 'This city is the capital of the northeastern state of Meghalaya', 'Aizawl', 'Agartala', 'Kohima', 'Shillong', 4, 1, 1),
	(15, 'Guess is the capital of the western state of Gujarat', 'Ahmedabad', 'Gandhinagar', 'Surat', 'Rajkot', 2, 1, 1),
	(16, 'Which of these states has Gangtok as its capital?', 'Nagaland', 'Tripura', 'Mizoram', 'Sikkim', 4, 1, 1),
	(17, 'What is the capital of Karnataka?', 'Coorg', 'Bengaluru', 'Mangaluru', 'Mysuru', 2, 1, 1),
	(18, 'This city is the capital of the hilly state of Himachal Pradesh', 'Leh', 'Manali', 'Chandigarh', 'Shimla', 4, 1, 1),
	(19, 'Guess the capital city of the northern state of Punjab', 'Jalandhar', 'Amritsar', 'Chandigarh', 'None of the above', 3, 1, 1),
	(20, 'Which of these is not a union territory?', 'Chandigarh', 'Ladakh', 'Pondicherry', 'Panaji', 4, 1, 1);
...
-- Dumping data for table testifly.user: ~3 rows (approximately)
...
-- Dumping data for table testifly.userrolemap: ~3 rows (approximately)
